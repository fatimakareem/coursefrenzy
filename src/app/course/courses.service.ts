...
export class CoursesService {
 ...
 get_recommendcourse(page) {
  ...
  get_courses_by_category(page,cat_id) {
    return this._http2.get(Config.api + 'courses/CoursesListbyCategory/'+ cat_id +'/?page=' + page).map((response: Response) => response.json());
  }
  get_courses_by_subcategory(page,subcat_id) {
    return this._http2.get(Config.api + 'courses/CoursesListbySubCategory/'+ subcat_id +'/?page=' + page).map((response: Response) => response.json());
  }
  ...
  get_top_rated_courses_via_subcategory(page,subcat_id) {
    return this._http2.get(Config.api + 'courses/topratedcoursesviasubcat/'+ subcat_id +'?page=' + page).map((response: Response) => response.json());
  }
  ...
  get_bid_courses_by_category(page,cat_id) {
    return this._http2.get(Config.api + 'courses/bid_courses_by_category/'+cat_id+'/').map((response: Response) => response.json());
  }
  get_bid_courses_by_subcategory(page,subcat_id) {
    return this._http2.get(Config.api + 'courses/bid_courses_by_subcategory/'+ subcat_id +'/?page='+ page).map((response: Response) => response.json());
  }
